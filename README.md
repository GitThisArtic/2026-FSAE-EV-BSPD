...
The tractive system current is determined based on the current input voltage of the throttle pedal. With a current of a tractive system current of _____ around at ____kW supplied to the motors under the 403.2V tractive system voltage. [Values still need to be measrued]
