...
The tractive system current is determined based on the current input voltage of the throttle pedal. With a current of 1.6381A from the throttle pedal set as the trip amount, the ACS770LCB-050U-PFF-T hall effect  sensor outputs 2.6271V, tripping the Tractive Logic to high.
